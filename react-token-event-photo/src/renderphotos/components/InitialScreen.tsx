            ...
            <div className="flex flex-col items-center w-full max-w-md space-y-4 mb-12">
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 w-full">
                    <button
                        ...
                        className="flex items-center justify-center w-full sm:w-1/2 px-6
                        py-3 bg-gray-800 text-white font-semibold rounded-lg shadow-md
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-full sm:w-1/2 px-6
                         py-3 bg-gray-800 text-white font-semibold rounded-lg shadow-md hover:bg-gray-100
