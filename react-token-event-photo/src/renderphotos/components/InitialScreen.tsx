...
const InitialScreen = ({ onStart }: InitialScreenProps) => {
    return (
        ...
        bg-gradient-to-b from-white to-gray-200 p-8">
            ...
            <button
                onClick={onStart}
                className="absolute bottom-10 w-[80%] py-4 bg-gray-800 text-white
                text-xl font-semibold rounded-lg hover:bg-gray-900 transition-colors shadow-lg"
            >
                Iniciar
            </button>
        </div>
